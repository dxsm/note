...
## 1. VIM插件及效果图
插件推荐：
* [NERDTree](https://github.com/scrooloose/nerdtree): 树型目录
* [supertab](https://github.com/ervandew/supertab): 自动补全，支持补全路径
* [UltiSnips](https://github.com/SirVer/ultisnips): 补全代码神器
* [vim-snippets](https://github.com/honza/vim-snippets): 将UltiSnips文件夹拷贝到~/.vim

效果图：
![vim效果图](assets/markdown-img-paste-20190504205744959.png)
